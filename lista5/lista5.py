...
print("    I1)")
print("        Integraçao polinomial:", integracao_polinomial(f, 0, 1, 10))
print("        Quadratura de Gauss:", quadratura_gauss(0, 1, 10, f))

print("    I2)")
print("        Integraçao polinomial:", integracao_polinomial(f, 0, 5, 10))
...
print("    Integraçao polinomial:", integracao_polinomial(f, 0, 4, 3))
print("    Quadratura de Gauss:", quadratura_gauss(0, 4, 2, f))

print("\nQuestao 6:")
f = lambda x: 1/(1 + x*x)
print("    a) Regra do ponto médio:")
print("        Integraçao polinomial:", integracao_polinomial(f, 0, 3, 2))
print("        Quadratura de Gauss:", quadratura_gauss(0, 3, 2, f))

print("    b) Regra do trapézio:")
print("        Integraçao polinomial:", integracao_polinomial(f, 0, 3, 4))
print("        Quadratura de Gauss:", quadratura_gauss(0, 3, 4, f))

print("    c) Regra de Simpson:")
print("        Integraçao polinomial:", integracao_polinomial(f, 0, 3, 3))
print("        Quadratura de Gauss:", quadratura_gauss(0, 3, 3, f))
