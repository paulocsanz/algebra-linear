...
print("        Integração polinomial:", integracao_polinomial(f, 0, 3, 2))
print("        Quadratura de Gauss:", quadratura_gauss(0, 3, 2, f))

print("    b) Regra do trapézio:")
print("        Integração polinomial:", integracao_polinomial(f, 0, 3, 4))
print("        Quadratura de Gauss:", quadratura_gauss(0, 3, 4, f))

print("    c) Regra de Simpson:")
print("        Integração polinomial:", integracao_polinomial(f, 0, 3, 3))
